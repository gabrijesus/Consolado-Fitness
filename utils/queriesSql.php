<?php 
    ...
    define("QUERY_INSERT_FICHA_TREINO", "INSERT INTO ficha_de_treino (nome_ficha_treino, id_usuario, exercicios) VALUES (?,?,?)");
    define("QUERY_SELECT_USER", "SELECT * FROM usuarios WHERE id_usuario = ?");
    define("QUERY_UPDATE_USER", "UPDATE usuarios SET nome_usuario = ?, email = ?, nivel_treino = ?, preferencia_treino = ?, data_nascimento = ?, sexo = ? WHERE id_usuario = ?");
?>